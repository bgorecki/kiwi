...
public class HibernateUtil {
 ...
 // TODO Usunąć w późniejszej fazie
    static public void createDataForTesting() {
	    ...
	    lotDao.create(new DbLotEntity().withCenaStatyczna(700F).withCzasPodrozy(1).withDzienTygodnia(6).withGodzinaPrzylotu(new Time(godz(1))).withGodzinaWylotu(new Time(godz(2))).withLotniskoByPrzylot(balice).withLotniskoByWylot(jasionka).withPrzewoznikByIdPrzew(lot));
	    ...
	    lotDao.create(new DbLotEntity().withCenaStatyczna(850F).withCzasPodrozy(2).withDzienTygodnia(6).withGodzinaPrzylotu(new Time(godz(3))).withGodzinaWylotu(new Time(godz(5))).withLotniskoByPrzylot(jasionka).withLotniskoByWylot(okecie).withPrzewoznikByIdPrzew(eurolot));
	    lotDao.create(new DbLotEntity().withCenaStatyczna(70F).withCzasPodrozy(3).withDzienTygodnia(6).withGodzinaPrzylotu(new Time(godz(6))).withGodzinaWylotu(new Time(godz(9))).withLotniskoByPrzylot(frnakfurt).withLotniskoByWylot(balice).withPrzewoznikByIdPrzew(luftwafe));
	    lotDao.create(new DbLotEntity().withCenaStatyczna(150F).withCzasPodrozy(9).withDzienTygodnia(6).withGodzinaPrzylotu(new Time(godz(11))).withGodzinaWylotu(new Time(godz(20))).withLotniskoByPrzylot(jfk).withLotniskoByWylot(frnakfurt).withPrzewoznikByIdPrzew(ua));
	    lotDao.create(new DbLotEntity().withCenaStatyczna(950F).withCzasPodrozy(9).withDzienTygodnia(6).withGodzinaPrzylotu(new Time(godz(9))).withGodzinaWylotu(new Time(godz(1))).withLotniskoByPrzylot(jfk).withLotniskoByWylot(jasionka).withPrzewoznikByIdPrzew(luftwafe));
