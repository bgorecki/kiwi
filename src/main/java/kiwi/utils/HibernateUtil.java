...
public class HibernateUtil {
 ...
 // TODO Usunąć w późniejszej fazie
    static public void createDataForTesting() {
	    ...
	    DbRezerwacjaEntity rezerwacjaEntity;

	    rezerwacjaDao.create(rezerwacjaEntity = new DbRezerwacjaEntity().withCenaCalkowita(16200.00F));

	    GenericDao<DbPasazerEntity, Integer> pasazerDao = new GenericDao<>(DbPasazerEntity.class);
	    DbPasazerEntity pax, pax2;
	    pasazerDao.create(pax = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Bolec").withNazwisko("Kolec").withWiek("Adult").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    pasazerDao.create(pax2 = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Asx").withNazwisko("Kpr").withWiek("Infant").withRezerwacjaByIdRezerw(rezerwacjaEntity));

	    GenericDao<DbRekordyLotuEntity, Integer> rekordyDao = new GenericDao<>(DbRekordyLotuEntity.class);
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotOJ).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotJJFK).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));

	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotOJ).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotJJFK).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));

	    rezerwacjaDao.create(rezerwacjaEntity = new DbRezerwacjaEntity().withCenaCalkowita(16200.00F));
	    pasazerDao.create(pax = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Bolec7").withNazwisko("Kolec12").withWiek("Adult").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    pasazerDao.create(pax2 = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Asx1").withNazwisko("Kpr12").withWiek("Infant").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotOJ).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotJJFK).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotOJ).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotJJFK).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    ...
	    pasazerDao.create(pax = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Bolec7").withNazwisko("Kolec12").withWiek("Adult").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    pasazerDao.create(pax2 = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Asx1").withNazwisko("Kpr12").withWiek("Infant").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotOJ).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotJJFK).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotOJ).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withKlasaByIdKlas(k1).withLotByIdLot(lotJJFK).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));

	    rezerwacjaDao.create(rezerwacjaEntity = new DbRezerwacjaEntity().withCenaCalkowita(16200.00F));
	    pasazerDao.create(pax = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Bolec77").withNazwisko("Kolec14").withWiek("Adult").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    pasazerDao.create(pax2 = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Asx12").withNazwisko("Kpr121").withWiek("Infant").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotOJ).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotJJFK).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotOJ).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotJJFK).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));

	    rezerwacjaDao.create(rezerwacjaEntity = new DbRezerwacjaEntity().withCenaCalkowita(16200.00F));
	    pasazerDao.create(pax = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Bolec771").withNazwisko("Kolec114").withWiek("Adult").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    pasazerDao.create(pax2 = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Asx112").withNazwisko("Kpr1211").withWiek("Infant").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k3).withLotByIdLot(lotOJ).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k3).withLotByIdLot(lotJJFK).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k3).withLotByIdLot(lotOJ).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k3).withLotByIdLot(lotJJFK).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));

	    rezerwacjaDao.create(rezerwacjaEntity = new DbRezerwacjaEntity().withCenaCalkowita(16200.00F));
	    pasazerDao.create(pax = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Bolec77").withNazwisko("Kolec14").withWiek("Adult").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    pasazerDao.create(pax2 = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Asx12").withNazwisko("Kpr121").withWiek("Infant").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotOB).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotBF).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotFJFK).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotOB).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotBF).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 8, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotFJFK).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));

	    rezerwacjaDao.create(rezerwacjaEntity = new DbRezerwacjaEntity().withCenaCalkowita(16200.00F));
	    pasazerDao.create(pax = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Bolec77").withNazwisko("Kolec14").withWiek("Adult").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    pasazerDao.create(pax2 = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Asx12").withNazwisko("Kpr121").withWiek("Infant").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotOB).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotBF).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotFJFK).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotOB).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotBF).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotFJFK).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    ...
	    pasazerDao.create(pax = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Bolec77").withNazwisko("Kolec14").withWiek("Adult").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    pasazerDao.create(pax2 = new DbPasazerEntity().withDataUr(new Date(1990, 03,01)).withImie("Asx12").withNazwisko("Kpr121").withWiek("Infant").withRezerwacjaByIdRezerw(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 22, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotOB).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 22, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotBF).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 22, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotFJFK).withPasazerByIdOs(pax).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 22, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotOB).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
	    rekordyDao.create(new DbRekordyLotuEntity().withDataWylotu(new Date(new DateTime(2013, 6, 15, 0, 0).toDate().getTime())).withDataPrzylotu(new Date(new DateTime(2013, 6, 22, 0, 0).toDate().getTime())).withKlasaByIdKlas(k2).withLotByIdLot(lotBF).withPasazerByIdOs(pax2).withCenaDynamiczna(750F).withRezerwacjaByIdRez(rezerwacjaEntity));
