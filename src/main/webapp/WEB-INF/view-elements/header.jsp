...
<head>
    ...
    <!-- Generic libs -->
    <script type="text/javascript" src="<c:url value="/js/ui/js/jquery.js"/>"></script>
            ...
            <ul>
                <c:choose>
                    <c:when test="${pageContext.request.servletPath == '/showAirlineCompanies.jsp'}">
                        <li class="current"><a href="airlinecompanies" title="Lista przewoźników">Lista przewoźników</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                ...
                <c:choose>
                    <c:when test="${pageContext.request.servletPath == '/addAirlineCompany.jsp'}">
                        <li class="current"><a href="airlinecompanies?action=addCompany" title="Dodaj przewoźnika">Dodaj
                            przewoźnika</a></li>
                    </c:when>
                    <c:otherwise>
                        <li><a href="airlinecompanies?action=addCompany" title="Dodaj przewoźnika">Dodaj przewoźnika</a>
                        </li>
                    </c:otherwise>
                </c:choose>
            </ul>
            ...
            <ul>
                ...
                <c:choose>
                    <c:when test="${pageContext.request.servletPath == '/addAirport.jsp'}">
                        <li class="current"><a href="<c:url value="addAirport.jsp"/>" title="Dodaj lotnisko">Dodaj
                            lotnisko</a></li>
                    </c:when>
                    <c:otherwise>
            ...
            <ul>
                <c:choose>
                    <c:when test="${pageContext.request.servletPath == '/showAirplanes.jsp'}">
                        <li class="airplane current"><a href="airplanes" title="Lista samolotów">Lista samolotów</a>
                        </li>
                    </c:when>
                    <c:otherwise>
                ...
                <c:choose>
                    <c:when test="${pageContext.request.servletPath == '/addAirplane.jsp'}">
                        <li class="current"><a href="<c:url value="addAirplane.jsp"/>" title="Dodaj samolot">Dodaj
                            samolot</a></li>
                    </c:when>
                    <c:otherwise>
                ...
                <c:if test="${sessionScope.user.rola eq 'przewoznik'}">
                    <c:choose>
                        <c:when test="${pageContext.request.servletPath == '/addFlights.jsp'}">
                            <li class="current"><a href="FlightController?action=editorsave" title="Dodaj połączenie">Dodaj
                                połączenie</a>
                            </li>
                        </c:when>
                        <c:otherwise>
                            <li><a href="FlightController?action=editorsave" title="Dodaj połączenie">Dodaj
                                połączenie</a></li>
                        </c:otherwise>
                    </c:choose>
                </c:if>
        ...
        <ul id="status-infos">
            <c:choose>
                <c:when test="${not empty sessionScope.user}">
                    ...
                    <li><a href="logout" class="button red" title="Wyloguj"><span class="smaller">WYLOGUJ</span></a>
                    </li>
                </c:when>
                <c:otherwise>
