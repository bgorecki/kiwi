	...
	<c:forEach var="airport" items="${airports}">
		<tr>
			...
			<form action="<c:url value="/airports"/>" method="post" style="float: right">
				...
				<input type="hidden" name="idLotniska" value="${airport.idLotniska}"/>
				<input type="image" title="Usuń lotnisko" class="with-tip" src="images/icons/fugue/cross-circle.png" width="16" height="16"  onclick="return confirm('Czy jesteś pewny? Operacja nie może być cofnięta!')"/>
			</form>
			</td>
		</tr>
	</c:forEach>
