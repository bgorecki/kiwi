...
<html>
<head>
    <title>Logowanie do anulowania rezerwacji</title>
    <meta charset="utf-8">
...
<!--[if lt IE 8]><div class="ie7"><![endif]-->
    ...
    <section id="login-block">
        <div class="block-border"><div class="block-content">
            ...
            -->
            <h1>Admin</h1>
            <div class="block-header">Autoryzacja dostępu</div>
            <c:if test="${not empty msg}"> 
                <p class="message error no-margin">${msg}</p>
            </c:if>
            
            <form class="form with-margin" name="login-form" id="login-form" method="post" action="removereservation">
                <input type="hidden" name="a" id="a" value="send">
                <p class="inline-small-label">
                    <label for="username"><span class="big">ID rezerwacji</span></label>
                    <input type="text" name="username" id="username" class="full-width" value="${param.username}">
                </p>
                <p class="inline-small-label">
                    <label for="password"><span class="big">Kod autoryzujący</span></label>
                    <input type="password" name="password" id="password" class="full-width" value="">
                </p>
                
                <button type="submit" class="float-right">Dalej</button>
            </form>
